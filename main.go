...
var (
	chainList                                                 = []string{"cosmos", "umee", "nyx", "osmosis", "juno", "akash", "regen", "microtick", "evmos", "rizon", "stargaze", "chihuahua", "gravity", "lum", "provenance", "crescent", "sifchain", "odin", "bitsong", "desmos"}
